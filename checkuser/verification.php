                    ...
                    <div class="grid">
                        <div class="row">
                            <section>
                                ...
                                <div class="checkUser">
                                    <h1 style="font-size: 26px; margin: 0;padding: 0;font-weight: bold;text-transform: unset;text-align: center;color: #fcaf17;line-height: 1;margin-bottom: 30px; ">NHẬP MÃ XÁC NHẬN</h1>
                                    <form method="POST" class="postLogin">
                                        <div class="form-outline mb-4">
                                            ...
                                            <?php if(isset($error['fail'])) : ?>
                                                <span style="color:red;"><?php $error['fail']?></span>
                                            <?php else: ?>
                                                <p style=" width: 385px;margin: 0 auto 10px;padding: 0;display: block; text-align: center; max-width: 100%;line-height: 15px;font-size: 14px;color: #000;">Nhập mã xác nhận trong email !</p>
                                            <?php endif; ?>
                                            <input name="text" placeholder="Nhập mã xác nhận" type="text" id="text" class="form-control form-control-lg" /><br>
                                        </div>
                                        <!-- Submit button -->
